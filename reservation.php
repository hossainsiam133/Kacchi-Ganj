...
<html lang="en">
  ...
  <body>
    <header class="header">
      ...
      <div class="section__container header__container" id="reservation">
        <div class="header__image">
          <img src="assets/reserveheader.png" alt="header" />
        </div>
        <div class="header__content">
          <h2>"একটি অসাধারণ ভোজন অভিজ্ঞতার জন্য কাচ্চি গঞ্জে টেবিল বুক করুন।"</h2>
          <h1>টেবিল বুক করুন</h1>
        </div>
      </div>
    </header>
